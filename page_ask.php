...
$mensalidade = isset($_POST['mensalidade']) ? $_POST['mensalidade'] : '';

// Verificar se os campos obrigatórios estão preenchidos
if (empty($nome) || empty($endereco) || empty($email) || empty($telefone) || empty($Curso) || empty($mensalidade)) {
    echo "Por favor, preencha todos os campos obrigatórios.";
} else {
    // Inserir dados no banco de dados sem o campo mensalidade
    $sql = "INSERT INTO comedio1(nome, endereco, email, telefone, idCurso, mensalidade)
            VALUES ('$nome', '$endereco', '$email', '$telefone', '$Curso', '$mensalidade')";
    ...
    <div class="wrapper">
                        ...
                        <div class="menu-container">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="page_login1.php">Login</a></li>
                                        <li><a href="page_registration1.php">Registro</a></li>
                                    </ul>
                                </li>
                                <!-- Fim dos Recursos -->
        ...
        <div class="job-img margin-bottom-30">
            <div class="job-banner">
                <h2>Centro de Orientação para Ensino Medio ...</h2>
            </div>
        ...
        <form method="post" action="" enctype="multipart/form-data" id="sky-form1" class="sky-form">
            <header>Formulário de Orientação para Ensino Medio</header>
                    ...
                    <section class="col col-6">
                        <label class="select">
                            <select name="mensalidade">
                                <option value="0" selected disabled>mensalidade</option>
                                <option value="27.000kzs">27.000kzs</option>
                                <option value="17.000kzs">17.000kzs</option>
                                <option value="50.000kzs">50.000kzs</option>
                                <option value="37.000kzs">37.000kzs</option>
                            </select>
                            <i></i>
                        </label>
                    </section>
