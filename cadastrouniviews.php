...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($name) || empty($endereco) || empty($curso) || empty($propina)) {
        ...
        $insert = "INSERT INTO universidade (instituicao, endereco, idCurso, proprina) VALUES ('$name', '$endereco', '$curso', '$propina')";
    ...
    <div class="col-sm-6">
        <input type="text" class="form-control" name="propina" value="<?php echo $propina; ?>">
            ...
            <div class="row mb-3">
               ...
               <div class="offset-sm-3 col-sm-3 d-grid">
    <a href="univiews.php" class="btn btn-primary">Lista</a>
</div>
            </div>
        </form>
    </div>
