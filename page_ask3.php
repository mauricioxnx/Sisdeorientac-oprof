...
if (empty($nome) || empty($endereco) || empty($email) || empty($telefone) || empty($Curso) || empty($instituicao)) {
    ...
    $sql = "INSERT INTO prof1(nome, endereco, email, telefone, idCurso, idunver)
    ...
    <div class="wrapper">
        ...
        <div class="job-img margin-bottom-30">
            <div class="job-banner">
                <h2>Centro de Orientação para area profissional ...</h2>
            </div>
        ...
        <form method="post" action="" enctype="multipart/form-data" id="sky-form1" class="sky-form">
            <header>Formulário de Orientação para area profissional</header>
                    ...
                    <section class="col col-6">
                        <label class="select">
                             <select name="instituicao">
                                <option value="none" selected disabled>Selecione a universidade</option>
                                <?php
                                // Consulta SQL para obter as instituições
                                $sqlInstituicao = "SELECT idunver, instituicao FROM universidade";
                                ...
                                if ($resultInstituicao->num_rows > 0) {
                                    ...
                                    while ($rowInstituicao = $resultInstituicao->fetch_assoc()) {
                                        $idInstituicao = $rowInstituicao['idunver'];
