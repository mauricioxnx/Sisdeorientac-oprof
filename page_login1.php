	...
	if (mysqli_num_rows($result) > 0) {
		...
		if ($row['use_type'] == 'admin') {
		 ...
		 elseif ($row['use_type'] == '') {
			...
			$_SESSION['user_name'] = $row['nome'];
			header('location:page_jobs2.php');
...
<body>
	...
	<div class="container">
		...
		<div class="reg-block">
			<div class="reg-block-header">
				...
				<p>Não tem uma conta? Clique <a class="color-green" href="page_registration1.php">aqui</a> para se
					cadastrar.</p>
			</div>
   ...
   <div class="row">
      <div class="col-md-10 col-md-offset-1">
         <button type="submit" class="btn-u btn-block" name="submit">Entrar</button>
      </div>
   </div>
</form>
