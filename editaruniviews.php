...
if (!empty($_GET['id'])) {
    $id = $_GET['id'];
    $query = "SELECT * FROM universidade WHERE idunver = $id";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update = "UPDATE universidade SET instituicao = '$nome', endereco = '$endereco', idCurso = '$curso', proprina = '$propina' WHERE idunver = $id";
