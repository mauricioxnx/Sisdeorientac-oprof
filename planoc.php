...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($iduser) || empty($iduni) || empty($data)) {
        $error = "Por favor, preencha todos os campos.";
    } else {
        // Monta a query de inserção
        $insert = "INSERT INTO planouni (iduser, iduni, data) VALUES ('$iduser', '$iduni', '$data')";
...
<body>
    <div class="container my-5">
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                <label class="col-sm-3 col-form-label">universidade</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="iduni" value="<?php echo $iduni; ?>">
                </div>
            </div>
